...
var choices = require('../process/choices/socat');

var socatProcessRelPath = '../process/socat';
...
Socat.initNetwork = function (socatServerIp, socatServerPort, socatBoardIp) {
    ...
    socatProcess.on('message', function (msg) {
        ...
        if (msg.name !== choices.name)  // todo ??? what's the purpose of this?
            return;
        ...
        } else if (msg.status === choices.messageStatusChoices.complete) {
