...
AutobahnConntestTcpkillWAMPConnection.prototype._onopen = function (session, details) {
    ...
    return AutobahnConntestTcpkillWAMPConnection.super_.prototype._onopen.call(this, session, details);
};
...
AutobahnConntestTcpkillWAMPConnection.prototype._onclose = function (reason, details) {
    ...
    return AutobahnConntestTcpkillWAMPConnection.super_.prototype._onclose.call(this, reason, details);
};
