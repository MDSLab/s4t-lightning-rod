 ...
 * @abstract
 */
BaseWAMPSession.prototype.register = function (procedure, endpoint, options) {
    throw new Error("Abstract method!");
};
 ...
 * @abstract
 */
BaseWAMPSession.prototype.call = function (procedure, args, kwargs, options) {
    throw new Error("Abstract method!");
};
 ...
 * @abstract
 */
BaseWAMPSession.prototype.publish = function (topic, args, kwargs, options) {
    throw new Error("Abstract method!");
};
 ...
 * @abstract
 */
BaseWAMPSession.prototype.subscribe = function (topic, handler, options) {
    throw new Error("Abstract method!");
};
