...
/**
 * Kills the process
 * @param signal optional, as string. see https://nodejs.org/api/child_process.html#child_process_child_kill_signal
 */
...
RunningPluginsTracker.prototype.isAlive = function (pluginName) {
    if (!this._runningPlugins.hasOwnProperty(pluginName))
        return false;
