...
Network.addToVlan = function (vlanID, boardVlanIP, vlanMask, vlanName) {
    ...
    var addVlanIfaceProcess = spawn('ip', ['link', 'add', 'link', 'gre-lr0', 'name', 'gre-lr0.' + vlanID, 'type', 'vlan', 'id', vlanID]);
    ...
    addVlanIfaceProcess.on('close', function (code) {
        ...
        var addVlanIpProcess = spawn('ip', ['addr', 'add', boardVlanIP + '/' + vlanMask, 'dev', 'gre-lr0.' + vlanID]);
