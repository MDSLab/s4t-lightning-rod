...
function prettyJsonStringify(o) {
...
PluginsState.prototype.writeGlobalPluginsConfig = function (pluginsConf) {
    return fspromised.writeFile(this._globalPluginsConfigFilepath, prettyJsonStringify(pluginsConf));
};
...
PluginsState.prototype.writeGlobalPluginsConfigSync = function (pluginsConf) {
    fs.writeFileSync(this._globalPluginsConfigFilepath, prettyJsonStringify(pluginsConf));
};
...
PluginsState.prototype.writePluginConfig = function (pluginName, pluginConf) {
    return fspromised.writeFile(this._getPluginConfPathByName(pluginName), prettyJsonStringify(pluginConf));
};
