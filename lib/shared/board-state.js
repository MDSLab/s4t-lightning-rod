...
BoardPosition.prototype.getHash = function () {
    return {
...
BoardState.prototype.reload = function (nconf_) {
    ...
    var registrationStatus = _validateRegistrationStatus.call(this, nconf_.get(this._registrationStatusNconfPath));
...
function _saveState() {
    nconf.set(this._positionNconfPath, this._position.getHash());
