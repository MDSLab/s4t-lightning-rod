...
```
npm install -g --unsafe gyp autobahn@18.10.2 ws@6.1.0 nconf @mdslab/wstun requestify is-running connection-tester log4js@1.1.1 q fs-access jsonfile md5 python-shell net lsof fuse-bindings mknod
