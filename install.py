	...
	if len(argv) == 2:
		if(argv[1] == 'yun'):
			try:
				...
				shutil.copytree('/opt/node-lighthing-rod/node_modules_yun', '/opt/node-lighthing-rod/node_modules')
				...
				print 'You can start now the service whit the command "/etc/ini.d/s4t_stable start"'
