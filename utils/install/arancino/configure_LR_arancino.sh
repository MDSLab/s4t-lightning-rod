...
sed -i "s,\"url_wamp\":.*,\"url_wamp\": \"ws://crossbar.$2\"\,,g" /var/lib/iotronic/settings.json
sed -i "s,\"port_wamp\":.*,\"port_wamp\": \"80\"\,,g" /var/lib/iotronic/settings.json
sed -i "s,\"url_reverse\":.*,\"url_reverse\": \"ws://wstun.$2\"\,,g" /var/lib/iotronic/settings.json
sed -i "s,\"port_reverse\":.*,\"port_reverse\": \"80\",g" /var/lib/iotronic/settings.json
